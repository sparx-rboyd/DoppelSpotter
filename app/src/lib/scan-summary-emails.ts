...
function buildLogoUrl(): string {
  return `${buildAppBaseUrl()}/logo.svg`;
}
...
function buildScanSummaryEmailContent(scan: Scan, brand: BrandProfile) {
  ...
  const html = `
    <div style="margin:0;background:#f3f4f6;padding:24px;font-family:Inter,system-ui,-apple-system,BlinkMacSystemFont,'Segoe UI',sans-serif;color:#111827;">
