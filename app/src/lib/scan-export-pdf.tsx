...
function SourceIcon({ source, color }: { source: FindingSource; color: string }) {
  ...
  if (source === 'apple_app_store') {
    return (
      <Svg viewBox="0 0 24 24" style={styles.badgeIcon}>
        <Path
          d="M18.05 12.615c.018 2.02 1.77 2.692 1.789 2.7c-.015.047-.28.952-.923 1.887c-.557.807-1.134 1.611-2.045 1.628c-.896.017-1.184-.532-2.208-.532c-1.024 0-1.344.515-2.191.549c-.88.033-1.551-.882-2.112-1.686c-1.146-1.656-2.022-4.679-.847-6.719c.583-1.013 1.626-1.655 2.759-1.672c.863-.017 1.678.582 2.208.582c.53 0 1.524-.72 2.568-.614c.437.018 1.666.177 2.455 1.33c-.064.04-1.464.854-1.453 2.547Zm-2.418-5.032c.467-.566.782-1.353.696-2.137c-.674.027-1.49.448-1.973 1.014c-.433.5-.813 1.301-.71 2.068c.75.058 1.521-.383 1.987-.945Z"
          fill={color}
        />
      </Svg>
    );
  ...
  if (source === 'google_play') {
    return (
      <Svg viewBox="0 0 24 24" style={styles.badgeIcon}>
        <Path d="M3.4 2.4l10.941 10.94L3.41 24a1.9 1.9 0 0 1-.31-1.052V3.454c0-.395.11-.765.3-1.054Z" fill={color} opacity="0.35" />
        <Path d="M16.5 15.5l-2.16-2.16l2.165-2.164l3.18 1.807c1.038.59 1.038 2.083 0 2.673L16.5 17.46Z" fill={color} />
        <Path d="M4.06 1.76L17.82 9.57l-3.48 3.48L3.4 2.11c.17-.14.4-.24.66-.35Z" fill={color} opacity="0.6" />
        <Path d="M3.4 24l10.94-10.95l3.48 3.48L4.05 24.34c-.25-.1-.48-.2-.65-.34Z" fill={color} opacity="0.8" />
      </Svg>
    );
  }
