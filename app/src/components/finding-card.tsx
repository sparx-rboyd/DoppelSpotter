  ...
  return (
    <>
      <div
        ...
        className={cn(
          'border-b border-gray-100 p-0 pb-3 last:border-b-0 transition-all duration-200 sm:rounded-xl sm:border sm:p-5 lg:rounded-2xl lg:p-6',
      ...
      >
        ...
        <div className="flex items-start gap-3 sm:gap-5 lg:gap-6">
          <div className="flex flex-shrink-0 flex-col items-center gap-2 lg:gap-3">
            <Tooltip content={src.label}>
              <span
                role="img"
                aria-label={src.label}
                className={cn(
                  'inline-flex rounded-lg p-2 sm:p-3 lg:rounded-xl lg:p-3.5',
          ...
          <div className="flex-1 min-w-0">
            ...
            <div className="mb-3 flex flex-col gap-1.5 sm:flex-row sm:items-start sm:justify-between sm:gap-3 lg:mb-4 lg:gap-5">
              <div className="min-w-0 sm:flex-1">
                <div className="flex flex-wrap items-center gap-2.5">
                  <h4
                    className={cn(
                      'text-base font-semibold lg:text-[1.0625rem]',
              ...
              {finding.url && (
                <Tooltip content="Visit">
                  <a
                    ...
                    aria-label="Visit"
                    className="inline-flex h-7 w-7 items-center justify-center rounded-md border border-gray-200 bg-white text-gray-500 transition hover:bg-gray-50 hover:text-gray-900 lg:h-9 lg:w-9"
                ...
                {onReclassify && !isAddressed && (
                  isReclassifyDialogOpen ? (
                    <button
                      ...
                      className="inline-flex h-7 w-7 items-center justify-center rounded-md border border-gray-200 bg-white text-gray-500 transition disabled:opacity-60 lg:h-9 lg:w-9"
                    >
                      {reclassifying ? (
                        <Loader2 className="w-3.5 h-3.5 animate-spin" />
                      ) : (
                    ...
                    <Tooltip content="Reclassify">
                      <button
                        ...
                        aria-label="Reclassify"
                        className={cn(
                          'inline-flex h-7 w-7 items-center justify-center rounded-md border transition disabled:opacity-60 lg:h-9 lg:w-9',
            ...
            <div className="space-y-4 lg:space-y-5">
              {finding.theme && (
                <div className="hidden flex-wrap items-center gap-2 text-[11px] text-gray-500 sm:flex lg:gap-2.5">
                  {finding.theme && (
              ...
              {finding.url && shouldShowMatchedUrl && (
                <div className="flex items-start gap-2 break-all rounded-lg border border-gray-100 bg-gray-50 p-2.5 text-xs text-gray-500 lg:p-3.5">
              ...
              {(hasNote || editingNote) && (
                <div className="rounded-lg border border-brand-100 bg-brand-50/60 p-3 lg:p-4">
